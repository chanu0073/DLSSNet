...
class data_config:
    Experiment_name = "单被试训练测试_matt数据_basisGroup_sub09"
    model_name = "Conv+TransFormer+GPoolingV2+ClassTransHead+decoder+正交约束"
    ...
    # classhead_dim = 512
    statenum = np.arange(23, 24)
    num_class = 4
    data_path = '/home/wangkaixuan/Code/data/BCICIV_2a_mat/'
    dec_loss_alpha = 1
    reg_factor = 1
    ...
    savepath = '/disks/HDD2/wangkaixuan/ExperimentResult/'+Experiment_name
    ...
    # scheduler_parm ={'milestones':[50, 150, 450, 900], 'gamma':0.5}
    scheduler ="torch.optim.lr_scheduler.MultiStepLR"
